...
- **官网体验** — 新增点击火花、文字邻近动画、按钮高光、卡片边缘光效和分镜式标题动画。
- **影片预告** — 官网加入可访问的预告片弹窗，并新增 12 秒 WebM 游戏预告。
- **海岛世界** — 完善海面与地平线、天空渐变、月相、天气粒子和昼夜光照表现。
- **海洋生态** — 新增鲸鱼、海豚、鲨鱼等大型海洋生物事件，并增强鱼、虾、螃蟹与游客行为。
- **建造与存档** — 完善车辆材质、游客互动、自动存档开关和存档删除流程。
- **资源说明** — 补充环境音频和车辆模型的来源及授权信息。
